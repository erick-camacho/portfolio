  ...
  return (
    ...
    >
      <div className="text-center space-y-5" id="about">
        <p>I'm <strong>Erick Camacho</strong>, a <strong>Web Developer</strong> from <strong>México</strong>.</p>
        ...
        <p className="uppercase font-bold text-sm text-yellow-500 font-mono lg:text-lg">HTML5 - CSS3 - JavaScript - ReactJS - TailwindCSS - Firebase - Next.js</p>
      </div>
    </Section>
  );
}
